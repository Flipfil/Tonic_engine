...
namespace tonic::graphics
{
		...
		, m_clear_color(1,1,1,1)
	{
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_size.x, m_size.y, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr); TONIC_CHECK_GL_ERROR;
		...
		glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, m_size.x, m_size.y);  TONIC_CHECK_GL_ERROR;
		glBindRenderbuffer(GL_RENDERBUFFER, 0); TONIC_CHECK_GL_ERROR;
		glFramebufferRenderbuffer(GL_FRAMEBUFFER, 0x821A, GL_RENDERBUFFER, m_render_buffer_ID); TONIC_CHECK_GL_ERROR;
